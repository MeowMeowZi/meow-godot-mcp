...
**Current Milestone: v1.3 — 开发者体验优化**

**Goal:** 消除 MCP 工具使用中的摩擦点，让 AI 辅助游戏开发的工作流更顺畅。

- [ ] run_game 自动等待 bridge 连接后再返回（消除手动 sleep + 轮询）
- [ ] 所有工具统一根节点路径约定（"" 和 "." 均表示场景根节点）
- [ ] game output 可靠捕获（解决 file_logging 刷新时机问题或改用 companion 转发）
...
- 44 MCP tools, 7 prompt templates, MCP Resources protocol
- 15 phases shipped across 3 milestones (v1.0 → v1.1 → v1.2)
- GoogleTest unit tests + 9 automated UAT suites (Python)
...
---
*Last updated: 2026-03-20 after v1.2 milestone complete*
