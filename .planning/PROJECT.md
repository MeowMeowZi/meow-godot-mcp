...
**Current Milestone: v1.5 — AI 工作流增强**

**Goal:** 从"工具集"升级为"智能工作台"——让 AI 能更好地理解场景上下文、组合工具完成复杂任务、从错误中恢复，减少重复操作。

- [ ] 复合工具：高级"一键创建"工具（带碰撞体的角色、完整 UI 面板等多步操作合一）
- [ ] Resources 增强：丰富 MCP Resources 内容（场景脚本、信号连接图、节点详情），AI 自动获取上下文
- [ ] 智能错误处理：工具报错时提供诊断信息、修复建议、常见原因，帮助 AI 自我纠正
- [ ] Prompt 模板扩展：更多面向工作流的 Prompt 模板，指导 AI 如何组合工具完成游戏开发任务
...
- 50 MCP tools, 7 prompt templates, MCP Resources protocol
- 21 phases shipped across 5 milestones (v1.0 → v1.1 → v1.2 → v1.3 → v1.4)
- GoogleTest unit tests + 11 automated UAT suites (Python)
...
---
*Last updated: 2026-03-23 after v1.5 milestone started*
